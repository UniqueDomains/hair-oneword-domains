...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C406%20rows-8250df">
...
**Public extract:** 9,406 rows · **Live catalog:** 9,403 domains
...
- `hair.csv` — public CSV extract (9,406 rows)
- `hair.json` — public JSON extract (9,406 rows)
...
| ace.hair        | premium   | $812.50   | $812.50       | 88             | 57     | 3      | name.com                                     |
| forge.hair      | available | $1.99     | $20.99        | 62             | 44     | 5      | name.com                                     |
...
| ----------------------- | ------------------------------------------------ |
| 9,406-row public sample | 9,403 live domains                               |
